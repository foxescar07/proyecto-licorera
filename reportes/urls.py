...
urlpatterns = [
    ...
    # Mapea http://127.0.0.1:8000/reportes/resumen-diario-ajax/
    # Usado por el buscador de fecha del modal "Resumen Diario"
    path('resumen-diario-ajax/', views.resumen_diario_ajax, name='resumen_diario_ajax'),
]